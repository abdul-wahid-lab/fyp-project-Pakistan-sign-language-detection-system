    ...
    <main className="min-h-screen bg-black flex flex-col">
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 28, fontSize: 13 }}>
          <Link href="/about" style={{ color: 'rgba(255,255,255,0.45)', textDecoration: 'none' }}
            onMouseEnter={e => (e.currentTarget as HTMLElement).style.color = '#fff'}
            onMouseLeave={e => (e.currentTarget as HTMLElement).style.color = 'rgba(255,255,255,0.45)'}
          >About Us</Link>
          <Link href="/contact" style={{ color: '#fff', textDecoration: 'none', fontWeight: 600 }}>Contact Us</Link>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'flex-start', gap: 80, padding: '72px 96px' }}>
        ...
        <div style={{ flex: '0 0 360px' }}>
          ...
          <h1 style={{ fontSize: 'clamp(28px, 3vw, 44px)', fontWeight: 800, color: '#fff', lineHeight: 1.15, letterSpacing: '-0.03em', margin: '16px 0 20px' }}>
            We&apos;d love to{' '}
            <span style={{ color: 'rgba(255,255,255,0.25)' }}>hear from you</span>
          </h1>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 14 }}>
              ...
              <div>
                ...
                <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.4)' }}>cs.abdulwahid@gmail.com</div>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 14 }}>
              ...
              <div>
                <div style={{ fontSize: 13, fontWeight: 600, color: '#fff', marginBottom: 2 }}>Location</div>
                <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.4)' }}>Pakistan</div>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 14 }}>
              ...
              <div>
                <div style={{ fontSize: 13, fontWeight: 600, color: '#fff', marginBottom: 2 }}>GitHub</div>
                <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.4)' }}>PSL Recognition Project</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div style={{ flex: 1, maxWidth: 520 }}>
          {sent ? (
            <div className="dark-card" style={{ textAlign: 'center', padding: '64px 40px' }}>
              ...
              <h2 style={{ fontSize: 20, fontWeight: 700, color: '#fff', marginBottom: 10 }}>Message Sent!</h2>
              <p style={{ fontSize: 14, color: 'rgba(255,255,255,0.4)', marginBottom: 28 }}>Thanks for reaching out. We&apos;ll get back to you soon.</p>
            ...
            <form className="dark-card" onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
              <div>
                <label style={{ fontSize: 12, fontWeight: 600, color: 'rgba(255,255,255,0.4)', letterSpacing: '0.06em', textTransform: 'uppercase', display: 'block', marginBottom: 8 }}>
                  Name
                </label>
                <input
                  required
